package cn.edu.nju.software151250171.context.suffix_arrays;

import java.util.Arrays;

/**
 * 后缀排序算法的效率取决于Java的子字符串提取操作使用的内存空间，它是一个常数——每个子字符串都是由标准对象，指向原字符串的指针和它的长度组成的
 * 当交换两个字符串时，实际交换的仅仅是对他们的引用，而非字符串本身
 */
