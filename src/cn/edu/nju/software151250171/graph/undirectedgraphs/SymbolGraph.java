...
public class SymbolGraph {
    private ST<String, Integer> st;  // string -> index，符号表ST，键的类型为String(顶点名),值的类型为int(索引)
    private String[] keys;           // index  -> string，数组keys[]，用作反向索引，保存每个顶点索引所对应的顶点名
    private Graph graph;             // the underlying graph，Graph对象G，使用索引来引用图中顶点
